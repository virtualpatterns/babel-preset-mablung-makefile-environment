...
Test.serial('presets: [ \'...\' ] on index.cjs', async (test) => {
  ...
  let option = {
    ...
    'presets': [
      Require.resolve('@virtualpatterns/babel-preset-mablung-makefile-environment')
    ]
  }
...
Test.serial('presets: [ \'...\' ] on index.js', async (test) => {
...
Test.serial('presets: [ [ \'...\', ... ] ] on index.cjs using __require', async (test) => {
...
Test.serial('presets: [ [ \'...\', ... ] ] on index.js using __require', async (test) => {
